import { ChainId, WETH } from '@arbistar/sdk';
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.DOGE_TESTNET]: [WETH[ChainId.DOGE_TESTNET]],
...
export const MULTICALL_NETWORKS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.DOGE_TESTNET]: '0x02817C1e3543c2d908a590F5dB6bc97f933dB4BD',
